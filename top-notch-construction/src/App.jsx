    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <nav className="fixed w-full z-50 px-4 pt-6">
        <div className="max-w-7xl mx-auto">
          {/* Polygonal Glass Container - NO BORDER */}
          <div 
            className={`relative transition-all duration-500 ${scrolled ? 'bg-black/60' : 'bg-black/30'} backdrop-blur-2xl shadow-2xl shadow-black/50`}
            style={{
            ...
            <div className="relative px-6 py-4">
              <div className="flex justify-between items-center">
                ...
                <a href="#home" className="flex items-center space-x-3 group">
                  ...
                  {/* Company Name - Aggressive Font - Always Visible */}
                  <div>
                    <span className="block text-2xl sm:text-3xl font-black uppercase tracking-tight text-orange-500" style={{fontFamily: '"Russo One", Impact, sans-serif', fontWeight: '900', letterSpacing: '0.05em', textShadow: '2px 2px 4px rgba(0,0,0,0.5)'}}>
                      TOP NOTCH
                    </span>
                    <span className="block text-sm sm:text-base font-bold uppercase tracking-widest text-gray-400" style={{fontFamily: 'Rajdhani, "Arial Black", sans-serif', letterSpacing: '0.15em'}}>
                      CONSTRUCTION
                    </span>
                  </div>
                </a>
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 md:gap-12 items-center pt-24 pb-12">
          {/* Left Content */}
          <div className="space-y-6 md:space-y-8">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-none" style={{fontFamily: 'Teko, Impact, sans-serif'}}>
            ...
            <p className="text-lg sm:text-xl text-gray-300 leading-relaxed backdrop-blur-sm" style={{fontFamily: 'Rajdhani, sans-serif'}}>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4">
              <a 
                href="#contact" 
                className="inline-flex items-center justify-center space-x-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-orange-500 to-orange-600 font-bold uppercase tracking-wider transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/50 hover:-translate-y-1 group text-sm sm:text-base"
                style={{
                  fontFamily: 'Rajdhani, sans-serif',
              ...
              <a 
                href="#projects" 
                className="inline-flex items-center justify-center space-x-2 px-6 sm:px-8 py-3 sm:py-4 bg-white/5 backdrop-blur-xl border-2 border-orange-500/40 font-bold uppercase tracking-wider transition-all duration-300 hover:bg-orange-500/10 hover:border-orange-500 hover:-translate-y-1 text-sm sm:text-base"
                style={{
                  fontFamily: 'Rajdhani, sans-serif',
                  clipPath: 'polygon(10px 0, calc(100% - 10px) 0, 100% 10px, 100% calc(100% - 10px), calc(100% - 10px) 100%, 10px 100%, 0 calc(100% - 10px), 0 10px)'
                }}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 pt-6 md:pt-8">
              {stats.map((stat, idx) => {
                ...
                return (
                  <div key={idx} className="text-center p-3 sm:p-4 bg-white/5 backdrop-blur-xl border border-orange-500/20 hover:border-orange-500/40 transition-all"
                       style={{clipPath: 'polygon(8px 0, calc(100% - 8px) 0, 100% 8px, 100% calc(100% - 8px), calc(100% - 8px) 100%, 8px 100%, 0 calc(100% - 8px), 0 8px)'}}>
                    <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent" style={{fontFamily: 'Teko, Impact, sans-serif'}}>
                      {stat.number}
                    </div>
                    <div className="text-xs sm:text-sm text-gray-400 uppercase tracking-wide" style={{fontFamily: 'Rajdhani, sans-serif'}}>
                      {stat.label}
                    </div>
                  </div>
                );
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <div className="inline-block mb-6">
              <span className="text-sm uppercase tracking-widest text-orange-500" style={{fontFamily: 'Rajdhani, sans-serif'}}>Services</span>
            </div>
            <h2 className="text-6xl md:text-7xl font-bold mb-6 uppercase tracking-tight" style={{fontFamily: 'Teko, Impact, sans-serif'}}>
              What We <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Offer</span>
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg" style={{fontFamily: 'Rajdhani, sans-serif'}}>
              ...
              return (
                <div key={idx} className="group relative">
                  ...
                  <div className="relative h-full bg-zinc-900/50 p-8 rounded-2xl border border-orange-500/20 backdrop-blur-sm group-hover:border-orange-500/50 transition-all">
                    ...
                    <h3 className="text-2xl font-bold mb-4 uppercase tracking-tight" style={{fontFamily: 'Teko, Impact, sans-serif'}}>
                      {service.title}
                    </h3>
                    <p className="text-gray-400 leading-relaxed" style={{fontFamily: 'Rajdhani, sans-serif'}}>
                      {service.desc}
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="inline-block mb-6">
                <span className="text-sm uppercase tracking-widest text-orange-500" style={{fontFamily: 'Rajdhani, sans-serif'}}>Why Us</span>
              </div>
              <h2 className="text-6xl md:text-7xl font-bold mb-8 uppercase tracking-tight" style={{fontFamily: 'Teko, Impact, sans-serif'}}>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={idx} className="flex items-start space-x-4 group">
                    ...
                    <p className="text-gray-300 text-lg leading-relaxed" style={{fontFamily: 'Rajdhani, sans-serif'}}>
                      {item}
                    </p>
                  </div>
                ))}
      ...
      <section id="projects" className="relative py-32 px-4 bg-zinc-950">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <div className="inline-block mb-6">
              <span className="text-sm uppercase tracking-widest text-orange-500" style={{fontFamily: 'Rajdhani, sans-serif'}}>Portfolio</span>
            </div>
            <h2 className="text-6xl md:text-7xl font-bold mb-6 uppercase tracking-tight" style={{fontFamily: 'Teko, Impact, sans-serif'}}>
            ...
            {projects.map((project, idx) => (
              <div key={idx} className="group relative overflow-hidden rounded-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 z-20">
                  <span className="inline-block px-3 py-1 bg-orange-500/20 border border-orange-500/40 rounded-full text-xs uppercase tracking-wider text-orange-500 mb-3" style={{fontFamily: 'Rajdhani, sans-serif'}}>
                    {project.type}
                  </span>
                  <h3 className="text-2xl font-bold uppercase tracking-tight" style={{fontFamily: 'Teko, Impact, sans-serif'}}>
                    {project.name}
                  </h3>
                </div>
              </div>
      ...
      <section className="relative py-32 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <div className="inline-block mb-6">
              <span className="text-sm uppercase tracking-widest text-orange-500" style={{fontFamily: 'Rajdhani, sans-serif'}}>Testimonials</span>
            </div>
            <h2 className="text-6xl md:text-7xl font-bold mb-6 uppercase tracking-tight" style={{fontFamily: 'Teko, Impact, sans-serif'}}>
            ...
            {testimonials.map((testimonial, idx) => (
              <div key={idx} className="group relative">
                ...
                <div className="relative h-full bg-zinc-900/50 p-8 rounded-2xl border border-orange-500/20 backdrop-blur-sm group-hover:border-orange-500/50 transition-all">
                  ...
                  <p className="text-gray-300 mb-8 leading-relaxed" style={{fontFamily: 'Rajdhani, sans-serif'}}>
                    "{testimonial.text}"
                  </p>
                  <div className="pt-4 border-t border-orange-500/20">
                    <div className="font-bold uppercase tracking-wide" style={{fontFamily: 'Teko, Impact, sans-serif'}}>
                      {testimonial.name}
                    </div>
                    <div className="text-sm text-orange-500 uppercase tracking-wider" style={{fontFamily: 'Rajdhani, sans-serif'}}>
                      {testimonial.role}
                    </div>
                  </div>
                </div>
      ...
      <section id="contact" className="relative py-32 px-4 bg-zinc-900/30">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              <div className="inline-block mb-6">
                <span className="text-sm uppercase tracking-widest text-orange-500" style={{fontFamily: 'Rajdhani, sans-serif'}}>Contact</span>
              </div>
              <h2 className="text-5xl font-bold mb-6 uppercase tracking-tight" style={{fontFamily: 'Teko, Impact, sans-serif'}}>
                Get In <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Touch</span>
              </h2>
              <p className="text-gray-400 mb-12 text-lg leading-relaxed" style={{fontFamily: 'Rajdhani, sans-serif'}}>
                ...
                {[
                  ...
                  return (
                    <div key={idx} className="flex items-center space-x-4 group">
                      ...
                      <span className="text-gray-300 text-lg" style={{fontFamily: 'Rajdhani, sans-serif'}}>
                        {item.text}
                      </span>
                    </div>
                  );
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <div className="text-2xl font-bold uppercase tracking-tight" style={{fontFamily: 'Teko, Impact, sans-serif'}}>
                    Top Notch
                  </div>
                  <div className="text-xs text-gray-400 uppercase tracking-widest" style={{fontFamily: 'Rajdhani, sans-serif'}}>
                    Construction
                  </div>
                </div>
              </div>
              <p className="text-gray-400 leading-relaxed mb-6" style={{fontFamily: 'Rajdhani, sans-serif'}}>
                Building excellence across Louisiana for over two decades. Your trusted partner in construction.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-bold uppercase tracking-wider mb-6" style={{fontFamily: 'Teko, Impact, sans-serif'}}>
                Quick Links
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li className="text-gray-400" style={{fontFamily: 'Rajdhani, sans-serif'}}>
                  (504) 555-0123
                </li>
                <li className="text-gray-400" style={{fontFamily: 'Rajdhani, sans-serif'}}>
          ...
          <div className="pt-8 border-t border-orange-500/10">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex space-x-6 text-sm">
                <a href="#" className="text-gray-500 hover:text-orange-500 transition-colors" style={{fontFamily: 'Rajdhani, sans-serif'}}>
                  Privacy Policy
                </a>
