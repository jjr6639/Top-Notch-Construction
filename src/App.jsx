      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 md:gap-12 items-center pt-24 pb-12">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-none" style={{fontFamily: 'Bebas Neue, Impact, sans-serif'}}>
            ...
            <p className="text-lg sm:text-xl text-gray-300 leading-relaxed backdrop-blur-sm" style={{fontFamily: 'Oswald, sans-serif'}}>
              ...
              {stats.map((stat, idx) => {
                ...
                return (
                  <div key={idx} className="text-center p-3 sm:p-4 bg-white/5 backdrop-blur-xl border border-orange-500/20 hover:border-orange-500/40 transition-all"
                       style={{clipPath: 'polygon(8px 0, calc(100% - 8px) 0, 100% 8px, 100% calc(100% - 8px), calc(100% - 8px) 100%, 8px 100%, 0 calc(100% - 8px), 0 8px)'}}>
                    <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent" style={{fontFamily: 'Bebas Neue, Impact, sans-serif'}}>
                      {stat.number}
                    </div>
                    <div className="text-xs sm:text-sm text-gray-400 uppercase tracking-wide" style={{fontFamily: 'Oswald, sans-serif'}}>
                      {stat.label}
                    </div>
                  </div>
                );
